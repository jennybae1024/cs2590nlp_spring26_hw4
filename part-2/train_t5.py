...
def get_args():
    ...
    parser.add_argument('--data_folder', type=str, default='data',
                        help="Path to data folder (use 'data_preprocessed' for preprocessed data)")
...
def eval_epoch(args, model, dev_loader, gt_sql_pth, model_sql_path, gt_record_path, model_record_path):
    ...
    # Compute metrics
    sql_em, record_em, record_f1, error_msgs = compute_metrics(gt_sql_pth, model_sql_path, None, model_record_path)
